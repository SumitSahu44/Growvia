  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="px-6 md:px-20 grid grid-cols-2 md:grid-cols-4 gap-x-4 gap-y-10 md:gap-0 border-t border-white/10 pt-16 pb-16">
          ...
          <div ref={addToLinksRef} className="flex flex-col gap-4">
            ...
            {['Home', 'About', 'Services', 'Blogs', 'Contact'].map((item) => (
              <a key={item} href="#" className="text-lg hover:text-gray-300 transition-colors w-fit group">
                {item}
        ...
        {/* --- BOTTOM BAR --- */}
        <div className="w-full px-6 md:px-20 py-4 flex flex-col md:flex-row justify-between items-center text-xs text-gray-400 font-mono border-t border-white/5 bg-black/50 backdrop-blur-sm">
