        ...
        <div ref={containerRef} className="bg-white min-h-screen text-black overflow-hidden selection:bg-black selection:text-white">
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        <div className="mt-10 flex gap-10">
                            <div>
                                ...
                                <span className="text-xs uppercase tracking-widest text-gray-600">Years</span>
                            </div>
                            <div>
                                <span className="block text-4xl font-black">120+</span>
                                <span className="text-xs uppercase tracking-widest text-gray-600">Projects</span>
                            </div>
                        </div>
                    </div>
            ...
            <section ref={galleryRef} className="py-20 px-6 md:px-20">
                <div className="flex flex-col md:flex-row justify-between items-end mb-16">
                    ...
                    <p className="text-gray-700 text-lg max-w-md text-right mt-8 md:mt-0 font-medium">
