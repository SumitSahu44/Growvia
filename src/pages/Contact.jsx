    ...
    <div ref={containerRef} className="bg-white min-h-screen text-black overflow-x-hidden selection:bg-black selection:text-white">
      ...
      <section className="contact-grid px-6 md:px-20 py-20 max-w-[1600px] mx-auto flex flex-col lg:flex-row gap-16 lg:gap-24">
        ...
        <div ref={formRef} className="w-full lg:w-7/12 flex flex-col justify-center">
            ...
            <p className="text-xl md:text-2xl text-gray-500 mb-12 max-w-xl">
            ...
            <form className="flex flex-col gap-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    <div className="relative group">
                        ...
                        <label htmlFor="name" className="absolute left-0 top-4 text-xl text-gray-400 transition-all peer-focus:-top-6 peer-focus:text-xs peer-focus:uppercase peer-focus:tracking-widest peer-focus:text-black peer-placeholder-shown:top-4 peer-placeholder-shown:text-xl cursor-text">
                            What's your name?
                        </label>
                    </div>
                    <div className="relative group">
                        ...
                        <label htmlFor="email" className="absolute left-0 top-4 text-xl text-gray-400 transition-all peer-focus:-top-6 peer-focus:text-xs peer-focus:uppercase peer-focus:tracking-widest peer-focus:text-black peer-placeholder-shown:top-4 peer-placeholder-shown:text-xl cursor-text">
                            Your email address
                        </label>
                    </div>
                </div>
                ...
                <div className="relative group">
                    ...
                    <label htmlFor="org" className="absolute left-0 top-4 text-xl text-gray-400 transition-all peer-focus:-top-6 peer-focus:text-xs peer-focus:uppercase peer-focus:tracking-widest peer-focus:text-black peer-placeholder-shown:top-4 peer-placeholder-shown:text-xl cursor-text">
                ...
                {/* Services Selection */}
                <div>
                    <span className="block text-xs font-bold uppercase tracking-widest text-gray-400 mb-6">I'm interested in...</span>
                ...
                <div className="relative group mt-4">
                     ...
                     <label htmlFor="msg" className="absolute left-0 top-4 text-xl text-gray-400 transition-all peer-focus:-top-6 peer-focus:text-xs peer-focus:uppercase peer-focus:tracking-widest peer-focus:text-black peer-placeholder-shown:top-4 peer-placeholder-shown:text-xl cursor-text">
            ...
            <div className="mt-24 pt-10 border-t border-gray-100">
                <h3 className="text-sm font-bold uppercase tracking-widest text-gray-400 mb-8">FAQ</h3>
